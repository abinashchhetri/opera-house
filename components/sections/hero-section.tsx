...
export function HeroSection() {
  return (
    <section className="relative bg-gradient-to-br from-primary via-secondary to-primary/90 text-primary-foreground">
      ...
      <div className="relative container mx-auto px-4 py-24 lg:py-32">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl md:text-2xl font-medium text-primary-foreground/90">{COMPANY_INFO.tagline}</p>
