...
export const PORTFOLIO_PROJECTS: ProjectPortfolio[] = [
  {
    ...
    services: ["UPVC Sliding Windows", "UPVC Casement Doors", "UPVC Partitions"],
  },
  {
    ...
    services: ["Aluminum Partitions", "Aluminum Sliding Doors", "Aluminum Windows"],
  },
  {
    ...
    services: ["UPVC Windows", "Aluminum Sliding Doors", "Custom Aluminum Work"],
  },
  {
    ...
    services: ["UPVC Casement Windows", "Aluminum Partitions", "UPVC Sliding Windows"],
  },
  {
    ...
    services: ["Steel Fabrication", "Aluminum Industrial Doors", "Custom Steel Work"],
  },
  {
    id: "shopping-mall",
    ...
    services: ["Aluminum Storefronts", "Steel Structural Work", "Aluminum Partitions"],
  },
  {
    id: "private-villa",
    title: "Private Villa",
...
export const SERVICES = [
  {
    ...
    description: "Energy-efficient sliding windows with superior insulation and smooth operation.",
    icon: "Window",
  ...
  },
  {
    ...
    description: "Traditional style casement windows with modern UPVC technology for optimal performance.",
    icon: "Home",
    features: ["Traditional Design", "Secure Locking", "Easy Operation", "Durable"],
  },
  {
    id: "upvc-sliding-doors",
    title: "UPVC Sliding Doors",
    description: "Space-saving sliding doors perfect for patios, balconies, and room dividers.",
    icon: "DoorOpen",
    features: ["Space Saving", "Large Glass Panels", "Smooth Operation", "Security Features"],
  },
  {
    id: "upvc-casement-doors",
    title: "UPVC Casement Doors",
    description: "Classic hinged doors with modern UPVC construction for durability and style.",
    icon: "Door",
    features: ["Classic Style", "Multi-Point Locking", "Weather Sealing", "Customizable"],
  },
  {
    id: "upvc-partitions",
    title: "UPVC Partitions",
    description: "Flexible partition solutions for offices, homes, and commercial spaces.",
    icon: "Separator",
    features: ["Flexible Design", "Easy Installation", "Sound Dampening", "Modern Aesthetics"],
  },
  {
    id: "aluminum-works",
    title: "Aluminum Works",
    description: "Custom aluminum fabrication for windows, doors, and architectural elements.",
    icon: "Wrench",
    features: ["Custom Fabrication", "Corrosion Resistant", "Lightweight", "Modern Design"],
  },
  {
    id: "steel-works",
    title: "Steel Works",
    description: "Heavy-duty steel fabrication for industrial and commercial applications.",
    icon: "Hammer",
    features: ["Heavy Duty", "Industrial Grade", "Custom Solutions", "Structural Support"],
  },
]
...
export const PRODUCTS = [
  {
    ...
    category: "UPVC",
    description: "High-performance sliding window with multi-chamber profile and double glazing.",
    price: "Rs. 8,500 per sq.ft",
    features: ["Multi-chamber profile", "Double glazing", "Weather stripping", "Smooth sliding mechanism"],
    specifications: {
  ...
  },
  {
    ...
    category: "UPVC",
    description: "Traditional casement window with modern UPVC technology and secure locking.",
    price: "Rs. 7,800 per sq.ft",
    features: ["Multi-point locking", "Tilt & turn option", "Energy efficient", "Easy maintenance"],
    specifications: {
  ...
  },
  {
    ...
    category: "UPVC",
    description: "Large sliding door perfect for patios with maximum glass area and minimal frame.",
    price: "Rs. 12,000 per sq.ft",
    features: ["Large glass panels", "Smooth operation", "Security locks", "Weather resistant"],
    specifications: {
  ...
  },
  {
    ...
    category: "Aluminum",
    description: "Heavy-duty aluminum sliding window designed for commercial applications.",
    price: "Rs. 6,500 per sq.ft",
    features: ["Powder coated finish", "Thermal break", "Commercial grade", "Customizable"],
    specifications: {
      "Profile Series": "50mm",
  ...
  },
  {
    ...
    category: "Aluminum",
    description: "Modern aluminum partition system for office spaces with glass panels.",
    price: "Rs. 4,200 per sq.ft",
    features: ["Modular design", "Glass integration", "Cable management", "Easy reconfiguration"],
    specifications: {
  ...
  },
  {
    ...
    category: "Steel",
    description: "Heavy-duty steel fabrication for industrial and structural applications.",
    price: "Rs. 180 per kg",
    features: ["Custom design", "Welded construction", "Galvanized coating", "Structural grade"],
    specifications: {
      "Steel Grade": "IS 2062",
